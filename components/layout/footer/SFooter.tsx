...
import { footerLinks, footerResources } from "@/lib/data";
      ...
      <div className="container px-6 lg:px-8  ">
        <div className="grid grid-cols-2 sm:grid-cols-4 lg:grid-cols-6 gap-4 lg:gap-8 py-14 max-w-xs mx-auto sm:max-w-2xl md:max-w-3xl lg:max-w-full">
          ...
          <div className="lg:mx-auto text-center sm:text-left">
            ...
            <ul className="text-sm  transition-all duration-500">
              {footerResources?.slice(0, 5)?.map((url, idx) => (
                <li key={idx} className="mb-6">
                  <Link
                    target="_blank"
                    href={url.link}
          ...
          <div className="lg:mx-auto text-center sm:text-left">
            <h4 className="text-lg text-white font-medium mb-7">Manbalar</h4>
            <ul className="text-sm  transition-all duration-500">
              {footerResources?.slice(5, 10)?.map((url, idx) => (
                <li key={idx} className="mb-6">
                  <Link
                    target="_blank"
                    href={url.link}
          ...
          <div className="lg:mx-auto text-center sm:text-left">
            ...
            <ul className="text-sm  transition-all duration-500">
              {footerResources?.slice(10, 15)?.map((url, idx) => (
                <li key={idx} className="mb-6">
                  <Link
                    target="_blank"
                    href={url.link}
